...
\begin{wrapfigure}{R}{0.5\textwidth} %this figure will be at the right
	...
	\caption{Example image from simulation with inverse perspective mapping applied.}
	\label{f:ipmSim}
\end{wrapfigure}
...
\textbf{TODO: Feature mask creation (include the IPM mask)}
