...
\begin{figure}
	...
	\caption{Process of developing feature mask developed feature nodes. Nodes are placed (left) and individually connected to inbound and outbound nodes (centre left). A resulting mask is combined with the IPM mask (null area shown as TODOODODODO THIS) (centre right) to obtain the final model mask (right)}
